...
<body>
	...
	<tr>
	 ...
	 <tr><td colspan='2'>Dear <?php echo $landlordFirstName; ?>,</td></tr>
	 <?php  foreach($renter_data as $item) { ?>
	 <tr>
		 <td colspan='2'>	
			Thank you for verifying the lease information for Tenant <?php echo $item->renter_first_name . ' ' . $item->renter_middle_name . ' '. $item->renter_last_name . ' '. $item->renter_suffix; ?>. 
			<?php echo $item->renter_city . ' ' . $item->renter_address_line_one . ' '. $item->renter_address_line_two; ?>,	
			<?php echo $item->state_name . ' ' . $item->renter_zip_code; ?>.
		 </td>
	 </tr>
	 <?php } ?>	
	 <tr>
