...
<body>
	...
	<tr>
	 ...
	 <tr><td colspan='2'>Dear <?php echo $item->renter_first_name; ?>,</td></tr>
	 <tr>
		 <td colspan='2'>	
			Your landlord, <?php echo $landlordFirstName . ' ' . $landlordLastName; ?>, has confirmed and verified your lease information and will begin 
			accepting your monthly rent payments through Inspire. Should you need to change any information in your account, please visit
			inspirecredit.com and login to your account. Any changes to the lease terms will require re-verification by your landlord
	...
	<tr>
		<td colspan="2">
			Your checking account (xxxxxxxxx-2100) has been debited $59.50 for your annual subscription - two months free.
		</td>
	</tr>
	<tr>
