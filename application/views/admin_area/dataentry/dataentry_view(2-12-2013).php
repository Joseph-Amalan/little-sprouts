...
*/
    ...
    function make_item_rows(result_array) {
        ...
        $.each(parseArray, function(index, value) {
            ...
            string_buffer += "<td><input type='text' placeholder='in yyyy-mm-dd' name='input_test_date_first_" + index + "' id='input_test_date_first_" + index + "' value='" + value.test_date_first + "' /></td>";
...
//            string_buffer += "<td><input type='text' name='input_status_date_" + index + "' id='input_status_date_" + index + "' value='" + value.status_date + "' /></td>";
            string_buffer += "<td><input type='text' placeholder='in yyyy-mm-dd' name='input_test_date_second_" + index + "' id='input_test_date_second_" + index + "' value='" + value.test_date_second + "' /></td>";
        ...
        $('#sort-table1').append("<input type='hidden' value='" + Column + "' id='recordcount' name='recordcount' />");
		 ...
		 var teachername_first = $("#teachername1_first").val() + ' ' + $("#teachername1_last").val();
        var teachername_second = $("#teachername2_first").val() + ' ' + $("#teachername2_last").val();
        var teachername_third = $("#teachername3_first").val() + ' ' + $("#teachername3_last").val();
        var coacher_name = $("#coachername_first").val() + ' ' + $("#coachername_last").val();
        var director_name = $("#directorname_first").val() + ' ' + $("#directorname_last").val();
