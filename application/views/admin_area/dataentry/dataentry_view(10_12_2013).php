...
<script type="text/javascript">
    ...
    function make_item_rows(result_array) {
        ...
        var string_buffer = "";
        string_buffer += "<tr ><td colspan='20' align='right'>Student Details</td><td><button id ='editstudentForm' name='editstudentForm' type='submit' value='Submit' >Submit</button></td></tr>";
...
//            string_buffer += "<td><input type='text' name='input_status_date_" + index + "' id='input_status_date_" + index + "' value='" + value.status_date + "' /></td>";
        ...
        $('#sort-table1').append("<tr ><td ><button id ='editstudentForm_one' name='editstudentForm_one' type='submit' value='Submit' >Submit</button></td><td colspan='20' align='right'></td></tr>");
   ...
   var dataStrings = 'sumval=' + Sum;
    ...
    $(function() {
        $("#editstudentForm").livequery('click', function() {
            ...
            if (txtLength <= 0)
            {
                alert("Please Enter Any Teacher Name");
                return false;
            }
    ...
    $(function() {
        ...
        $("input:radio[name='userIpStatus']").livequery('change', function() {
           var UserIPStatus=$("input:radio[name='userIpStatus']:checked").val();
    //alert(UserIPStatus); 
 var confirmacao = confirm("Selecting an administrator will replace the administrator for all students on this page. Are yo sure you want to continue?");
    if(confirmacao) {
       // console.log("OK");
