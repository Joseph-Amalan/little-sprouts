...
<!-- <input type="text" size="12" id="inputField" readonly />-->
<style type="text/css">

#sort-table1 td input.small {
   width:50px;
  
}
#sort-table1 td input.medium {
   width:70px;
  
}
#sort-table1 td input.large {
   width:100px;
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        jQuery('#selectinstancename').change(function() { //any select change on the dropdown with id country trigger this code
            ...
            jQuery.ajax({
                type: "POST",
                url: "<?php echo base_url(); ?>" + "admin_area/data_entry/get_instance_school_list/" + instance_id, //here we are calling our user controller and get_cities method with the country_id
        ...
        jQuery('#school').change(function() { //any select change on the dropdown with id country trigger this code
            ...
            jQuery.ajax({
                type: "POST",
                url: "<?php echo base_url(); ?>" + "admin_area/data_entry/getclass_list/" + instance_id + '/' + school_id, //here we are calling our user controller and get_cities method with the country_id
        ...
        jQuery('#preclasses').change(function() { //any select change on the dropdown with id country trigger this code
            ...
            jQuery.ajax({
                type: "POST",
                url: "<?php echo base_url(); ?>" + "admin_area/data_entry/getstatus_list/" + instance_id + '/' + school_id + '/' + preclass_id, //here we are calling our user controller and get_cities method with the country_id
        ...
        jQuery('#status').change(function() { //any select change on the dropdown with id country trigger this code
            ...
            jQuery.ajax({
                ...
                url: "<?php echo base_url(); ?>" + "admin_area/data_entry/getstudent_list/" + instance_id + '/' + school_id + '/' + preclass_id + '/' + status_id, //here we are calling our user controller and get_cities method with the country_id
                //data: login_data,
...
<script type="text/javascript">
    ...
    $(function() {
        ...
        $("td[id^='submitform']").click(function() {
            ...
            var get_instance_id = document.getElementById('selectinstancename').value;//alert(get_instance_id);
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo base_url(); ?>" + "admin_area/data_entry/data_entry_get_all_student/",
                data: dataString,
                cache: false,
                //dataType: 'json',  
    ...
    function make_item_rows(result_array) {
        ...
        $.each(parseArray, function(index, value) {
            ...
            string_buffer += "<td><input type='text' class='small' name='input_child_id_" + index + "' id='input_child_id_" + index + "' value='" + value.child_id + "' readonly/></td>";
            string_buffer += "<td><input type='text' class='large' name='input_student_name_" + index + "' id='input_student_name_" + index + "' value='" + value.first_name + '  ' + value.last_name + "' readonly/></td>";
            string_buffer += "<td><input type='text' class='medium' placeholder='in yyyy-mm-dd' name='input_student_dob_" + index + "' id='input_student_dob_" + index + "' value='" + value.date_of_birth + "' readonly /></td>";
            string_buffer += "<td><input type='text' class='medium' name='input_enrollment_status_" + index + "' id='input_enrollment_status_" + index + "' value='" + value.enrollment_status + "' readonly/></td>";
            string_buffer += "<td><input type='text' class='medium' placeholder='in yyyy-mm-dd' name='input_status_date_" + index + "' id='input_status_date_" + index + "' value='" + value.status_date + "' readonly/></td>";


            string_buffer += "<td><input type='text' class='medium' placeholder='yyyy-mm-dd' name='input_test_date_first_" + index + "' id='input_test_date_first_" + index + "' value='" + value.test_date_first + "' /></td>";
            string_buffer += "<td><input type='text' class='small' placeholder='yy-mm' name='input_chronological_age_" + index + "' id='input_chronological_age_" + index + "' value='" + value.chronological_age + "' readonly/></td>";

            string_buffer += "<td><input type='text' class='small' name='input_topel_pkss_" + index + "' id='input_topel_pkss_" + index + "' value='" + value.topel_pkss + "' /></td>";
            string_buffer += "<td><input type='text' class='small' name='input_topel_dvss_" + index + "' id='input_topel_dvss_" + index + "' value='" + value.topel_dvss + "' /></td>";
            string_buffer += "<td><input type='text' class='small' name='input_topel_pass_" + index + "' id='input_topel_pass_" + index + "' value='" + value.topel_pass + "' /></td>";




            string_buffer += "<td><input type='text' class='small' name='input_topel_elindex_" + index + "' id='input_topel_elindex_" + index + "' value='" + value.topel_elindex + "' readonly/></td>";
            string_buffer += "<td><input type='text' class='small' name='input_topel_elindex_percentile_" + index + "' id='input_topel_elindex_percentile_" + index + "' value='" + value.topel_elindex_percentile + "' readonly/></td>";
            ...
            string_buffer += "<td><input type='text' class='large' name='input_administrator_" + index + "' id='input_administrator_" + index + "' value='" + value.administrator + "' /></td>";
            string_buffer += "<td><input type='text' class='medium' name='input_notes_first_" + index + "' id='input_notes_first_" + index + "' value='" + value.notes_first + "' /></td>";
//            string_buffer += "<td><input type='text' name='input_status_date_" + index + "' id='input_status_date_" + index + "' value='" + value.status_date + "' /></td>";
            string_buffer += "<td><input type='text' class='medium' placeholder='yyyy-mm-dd' name='input_test_date_second_" + index + "' id='input_test_date_second_" + index + "' value='" + value.test_date_second + "' /></td>";
            string_buffer += "<td><input type='text' class='medium' name='input_pals_upper_" + index + "' id='input_pals_upper_" + index + "' value='" + value.pals_upper + "' /></td>";
            string_buffer += "<td><input type='text' class='medium'  name='input_pals_lower_" + index + "' id='input_pals_lower_" + index + "' value='" + value.pals_lower + "' /></td>";
            string_buffer += "<td><input type='text' class='medium' name='input_pals_letter_sounds_" + index + "' id='input_pals_letter_sounds_" + index + "' value='" + value.pals_letter_sounds + "' /></td>";
            ...
            string_buffer += "<td><input type='text' class='large' name='input_administrator_second_" + index + "' id='input_administrator_second_" + index + "' value='" + value.administrator_second + "' /></td>";
            string_buffer += "<td><input type='text' class='medium' name='input_notes_second_" + index + "' id='input_notes_second_" + index + "' value='" + value.notes_second + "' /></td>";
 ...
 $(function() {
         $('input[id^=input_topel_pkss_]').livequery('blur', function() {
            var CurrentIndex = $(this).attr('id');
            var CurrentArray = CurrentIndex.split('_');
            var CurrentID = CurrentArray[3];  
             var topel_pkss = 0;
             
            topel_pkss = $('#input_topel_pkss_' + CurrentID).val();
           if ((!topel_pkss.match(/^[0-9]+$/)) && (topel_pkss!='')  )   
               
            {
                alert('please enter only numbers'); 
               $('#input_topel_pkss_' + CurrentID).val("");  
              $('#input_topel_pkss_' + CurrentID).focus();
              return false;
            }
               });
    });
$(function() {
         $('input[id^=input_topel_dvss_]').livequery('blur', function() {
            var CurrentIndex = $(this).attr('id');
            var CurrentArray = CurrentIndex.split('_');
            var CurrentID = CurrentArray[3];  
             var topel_dvss = 0;
             
            topel_dvss = $('#input_topel_dvss_' + CurrentID).val();
           
           if ((!topel_dvss.match(/^[0-9]+$/)) && (topel_dvss!='')  )         
            {
                alert('please enter only numbers'); 
               $('#input_topel_dvss_' + CurrentID).val("");  
              $('#input_topel_dvss_' + CurrentID).focus();
              return false;
            }
               });
    });
    $(function() {
         $('input[id^=input_topel_pass_]').livequery('blur', function() {
            var CurrentIndex = $(this).attr('id');
            var CurrentArray = CurrentIndex.split('_');
            var CurrentID = CurrentArray[3];  
             var topel_pass = 0;
             
            topel_pass = $('#input_topel_pass_' + CurrentID).val(); //alert(topel_pass);
           
           if ((!topel_pass.match(/^[0-9]+$/)) && (topel_pass!='')  )          
            {
                alert('please enter only numbers'); 
               $('#input_topel_pass_' + CurrentID).val("");  
              $('#input_topel_pass_' + CurrentID).attr("focus",true);
              return false;
            }
               });
    });
    $(function() {
        $('input[id^=input_topel_pkss_],input[id^=input_topel_dvss_],input[id^=input_topel_pass_]').livequery('change', function() {
            ...
            if (((Sum) >= 160) && ((Sum) <= 406)) {
                ...
                $.ajax({
                    type: "POST",
                    url: "<?php echo base_url(); ?>" + "admin_area/data_entry/data_entry_get_Early_Literacy_Index/",
                    data: dataStrings,
                    cache: false,
                    //dataType: 'json',  
                    success: function(html) {
    ...
    $(function() {
        $('input[id^=input_test_date_first_]').livequery('change', function() {
            ...
            if (start_date.match(/^\d{4}-((0\d)|(1[012]))-(([012]\d)|3[01])$/))
            {
                ...
                $.ajax({
                    type: "POST",
                    url: "<?php echo base_url(); ?>" + "admin_area/data_entry/getchronological_age/",
                    data: dataStrings,
                    cache: false,
                    //dataType: 'json',  
                    success: function(html) {
    ...
    /*$(function() {
     ...
     var UserhiddenIPStatus = $("input:radio[name='userIpStatus']:checked").val();
     jQuery("input[id^='hidden_radio_values']").val(UserhiddenIPStatus);
     
     // alert(UserhiddenIPStatus); 
     ...
     var hidd = jQuery("#hidden_radio_values").val(); 
     //var hidd = jQuery("#hidden_radio_values").val();
     //alert(hidd);
     $("input[name=userIpStatus][value=" + $(hidd).val() + "]").attr('checked', false);
     return false;
     }
...
<?php //$this->admin_template->add_js('includes/admin_area/scripts/jquery-1.9.1.js');  ?>
<?php //$this->admin_template->add_js('includes/admin_area/scripts/jquery-ui.js'); ?>
<script type="text/javascript">
    /*jQuery(function() {
...
<?php //$this->admin_template->add_css('includes/admin_area/styles/jsDatePick_ltr.min.css');  ?>
<?php //$this->admin_template->add_js('includes/admin_area/scripts/jsDatePick.min.1.3.js'); ?>
<script type="text/javascript">
    /*window.onload = function(){
     ...
     new JsDatePick({
     useMode:2,
     target:'input_test_date_first_0',
     //dateFormat:"%d-%M-%Y"
     dateFormat:"%Y-%m-%d"
