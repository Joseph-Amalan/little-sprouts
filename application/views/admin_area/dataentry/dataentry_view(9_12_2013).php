...
<script type="text/javascript">
    ...
    function make_item_rows(result_array) {
        ...
        var string_buffer = "";
        string_buffer += "<tr ><td colspan='18' align='right'>Student Details</td><td><button id ='editstudentForm' name='editstudentForm' type='submit' value='Submit' >Submit</button></td></tr>";
        ...
        string_buffer += "<tr><td>Student ID</td><td>Student Name</td><td>DOB</td><td>Enrollment Status</td><td>Status Date</td><td>TOPEL Test Date</td><td>Print Knowledge</td><td>Definitional Vocabulary</td><td>Phonological Awareness</td><td>Not Tested Reason</td><td>Administrator</td><td>Notes</td><td>PALS Test Date</td><td>Upper Case</td><td>Lower Case</td><td>Letter Sounds</td><td>Not Tested Reason</td><td>Administrator</td><td>Notes</td></tr>";
...
//            string_buffer += "<td><input type='text' name='input_status_date_" + index + "' id='input_status_date_" + index + "' value='" + value.status_date + "' /></td>";
        ...
        $('#sort-table1').append("<tr ><td ><button id ='editstudentForm_one' name='editstudentForm_one' type='submit' value='Submit' >Submit</button></td><td colspan='18' align='right'></td></tr>");
    ...
    $(function() {
        $("#editstudentForm").livequery('click', function() {
            ...
            if (txtLength <= 0)
            {
                alert("Please Enter Any Teacher Name & Click on the related Radion Button");
                return false;
            }
