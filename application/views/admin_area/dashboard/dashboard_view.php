...
<div class="page-title ui-widget-content ui-corner-all">
    ...
    <div class="other">
        <ul id="dashboard-buttons">
			...
			<li>
                <a href="<?php echo base_url(); ?>admin_area/create_instance" class="Box_recycle tooltip" title="Create Instance">Create Instance</a>
            </li>
			<li>
				<a href="<?php echo base_url(); ?>admin_area/list_instance/active_instance" class="Mail_compose tooltip" title="Edit/Delete Instance">Edit/Delete Instance</a>
			</li>	
            <li>
			...
			<li>
                <a href="<?php echo base_url(); ?>admin_area/report_data/index" class="Books tooltip" title="Report">Report in Grid View</a>
            </li>
            <!--            <li>
                <a href="<?php echo base_url(); ?>admin_area/examples/employees_management" class="Books tooltip" title="Grid">Grid</a>
            </li>-->
