    ...
    <div id="sidebar" class="sidebar">
        <div id="inbox-nav">
            <ul>
                ...
                <li class="nav-inbox active"><a href="<?php echo base_url();?>messages/inbox">Inbox</a></li>
	...
	<div id="content" class="inbox-v2">
		<div id="inbox-tabview" class="inbox-tabview">
			...
			<ul class="tabs-v2 inbox-tabview-nav">
				<li class="selected"><a href="<?php echo base_url();?>messages/inbox"><em>Messages</em></a></li>
				<?php	
				$user_id = $this->session->userdata('user_id');			
				$user_role = $this->session->userdata('user_role_id');
                ?>
                                
                <?php if($user_role == 2) { ?>
					<li class=""><a href="<?php echo base_url();?>invitations/pending"><em>Invitations</em></a></li>
				<?php } ?>
			</ul>
			<div class="content" class="inbox-v2">
				<div id="messages" class="inbox-null">
					<ul class="inbox-list">	
								...
								<a href="<?php echo base_url();?>messages/view/<?php echo $items->message_id; ?>">	
									<div class="item-content">
										<span class="participants">									
											...
											<?php 
											if($items->to_user == $items->from_user) { echo "me"; } else { echo $items->user_email; }
											?>
											</span>									
										</span>	
										<span class="subject">									
												<?php echo $items->subject; echo $items->counttitle;
												if($items->counttitle != 0) { echo '...(' . $items->counttitle . ')'; }   ?>									
										</span>								
						...
						{ ?>							
                         <br/><div class="notice">There are no new messages.</div>
						<?php 
						}
						?>
					</ul>
