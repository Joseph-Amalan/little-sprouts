...
class Import_model extends CI_Model {
	...
	function add_data ($insertValue) 				 
	 {		
	 //$insertQuery = $this->db->query("insert into user_details (name,job,email) values (".implode(',',$insertValue).")");
         $insertQuery = $this->db->query("insert into student_details (child_id,first_name,last_name,gender,voucher_number,date_of_birth,
             school_name,school_code,status_date,enrollment_status,primary_classroom) values (".implode(',',$insertValue).")");
