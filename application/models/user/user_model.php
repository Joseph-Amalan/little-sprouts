...
class User_model extends CI_Model {
	...
	function login_validate($username,$password) {
		 ...
		 $query = $this->db->query("SELECT  u.id,u.user_name,u.user_password,u.user_email, u.user_role FROM user_detail u INNER JOIN ls_roles r ON u.user_role = r.role_id 
		...
		if(($query->num_rows() == 1))
		{
			...
			$this->user_id							= $db_row->id;			
                        $this->user_role_id         			= $db_row->user_role;
