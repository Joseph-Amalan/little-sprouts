...
class CI_Admin_popup_template {
   ...
   function __construct()
   {
      ...
      include(APPPATH.'config/admin_popup_template'.EXT);
      if (isset($template))
      {
...
/* End of file Admin_template_view.php */
/* Location: ./system/application/libraries/Admin_template_view.php */