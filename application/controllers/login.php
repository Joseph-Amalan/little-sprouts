...
class Login extends CI_Controller {
    ...
    function __construct() 
    {
		...
		$this->template->write('title', "Login | Little Sprouts");	
	...
	function index() 
	 {				
		...
		$this->form_validation->set_rules('username', 'username', 'trim|required|min_length[5]|max_length[20]|username_custom|xss_clean');
		$this->form_validation->set_rules('password', 'Password', 'trim|required|min_length[5]|max_length[200]|xss_clean');
	...
	{
		                $logged_UserName = $this->session->userdata('user_name'); 
