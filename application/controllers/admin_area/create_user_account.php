...
class Create_user_account extends CI_Controller {
    ...
    function index() {
       ...
       $data = array();
        ...
        $this->form_validation->set_rules('username', 'Name', 'trim|required|valid_username|min_length[5]|max_length[20]|alpha_dash_space|xss_clean');
        ...
        if ($this->form_validation->run() == FALSE) {
             // $data['instances'] = $this->admin_model->get_instance_data();
