...
//                        $config['upload_path'] = $this->config->config['approot'].'/uploads/';
            ...
            $inputFileName = $_FILES['import_data_file']['name'];
                ...
                try {
                    ...
                    for ($row = 2; $row <= $highestRow; $row++) {
                        ...
                        for ($i = 0; $i < $countColumn; $i++) {                           
                            ...
                            $insertValue[] = "'" . $testInsertValue . "'";
                        }
                       // print_r($rowData);exit();
                        $this->db->trans_start();
                        $val = $this->import_model->add_data($insertValue);
                    }
        ...
        $this->admin_template->write_view('content', 'admin_area/import_data/import_data_view', TRUE);
