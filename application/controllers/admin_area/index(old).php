...
class Index extends CI_Controller {
   ...
   {	
		...
		$this->form_validation->set_rules('admin_password', 'Password', 'trim|required|min_length[6]|max_length[200]|xss_clean');
		...
		if($this->form_validation->run() == FALSE) {		
			...
			if($result == FALSE){
				...
				$this->session->set_flashdata('success_message', 'Welcome to Inspire Rocket');				
