...
class Create_user_account extends CI_Controller {
    ...
    function index() {
       ...
       // $this->form_validation->set_rules('username', 'Name', 'trim|required|valid_username|alpha_dash_space|min_length[5]|max_length[30]|');
	$this->form_validation->set_rules('username', 'Name','trim|required|valid_username|min_length[5]|max_length[20]|username_custom|xss_clean');


        $this->form_validation->set_rules('password', 'Password', 'trim|required|valid_password|min_length[5]|max_length[200]|xss_clean');
