...
class Examples extends CI_Controller {
	...
	public function __construct()
	{
        ...
        $this->admin_template->write('title', 'Admin Little Sprouts - Grid View');
	...
	{
		$this->load->view('admin_area/griddata/example',$output);
	}
	...
	public function employees_management()
	{
			...
			//$this->_example_output($output);
                         $this->admin_template->write_view('content', 'admin_area/griddata/example',$output, TRUE);
