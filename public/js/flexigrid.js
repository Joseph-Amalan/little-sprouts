...
function buildTable(item)
{
    ...
    headerTable = $('#' + "headerTbl")[0];
    $(tbl).append($('thead', headerTable));
    bodyTable = $('tbody', item)[0];
    $(tbl).append(bodyTable);

    $(tbl).css('border', '1px solid black').css('border-collapse', 'collapse').css('direction', 'rtl');
    $('th', tbl).css('border', '1px solid black');
    $('tr', tbl).css('border', '1px solid black');
    $('td', tbl).css('border', '1px solid black');
    return tbl;
}